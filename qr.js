...
let qrimg;
    ...
    const qrGen =  () => {
        ...
        qrimg = "https://api.qrserver.com/v1/create-qr-code/?data=" + eData.value +"&size=" + height.value +"x"+ width.value + "&format=" + format.value + "&fgcolor=" + qrcolor.value + "&bgcolor="+ bgcolor.value ;
